   ...
   $(".instruction-tap").click(function(){
    ...
    $(".invite-btn").click(function(){
        NativeBridge.share({
            ...
            link: `https://m.easyloan888.com/static/loan/outside-register/index.html?channelCode=JRGC&extInvCode=${factoryCode}&invitationCode=${USER.code}&jumpType=${$FW.Browser.inWeixin() ? 'wx' : 'app'}`, // 链接
