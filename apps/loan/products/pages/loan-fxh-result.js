                ...
                if (data.activityRecomUrl) {
                    ...
                    setTimeout(() => {
                        Browser.inApp ? NativeBridge.goto(`${data.activityRecomUrl}`, false, "放心花") :
                            document.referrer == `https://m.easyloan888.com/static/loan/products/index.html` ? location.replace(`https://m.easyloan888.com/static/loan/products/index.html#loan-fxh-result`) : location.href = `${data.activityRecomUrl}`;
                    }, 2000)
                }
                // setTimeout(() => {
