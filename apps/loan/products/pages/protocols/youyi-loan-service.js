...
export default class YouyiLoanService extends React.Component {
    ...
    render() {
        ...
        现双方就以上服务达成一致，特订立本协议。
            ...
            2.5  甲方同意并授权乙方合作的商业银行或第三方平台等主体根据其相关规则以甲方名义注册开户并与出借人签署《借款合同》及其他与借款相关的协议。甲方同意并授权乙方将甲方借款信息通过系统自动传输至商业银行或第三方平台等主体，由其系统自动生成《借款合同》及其他与借款相关的协议。
            2.6  为便于甲方借款的收付，甲方同意并授权乙方及其合作方通过系统自动设置交易密码并开通免密支付功能，在相关合同生效后即通过系统自动向相关方发出付款指令，将相关款项支付至甲方指定银行账户中。
        	2.7	 甲方应按照本协议的规定向乙方支付服务费并按《借款合同》约定按时偿还借款本息及其他应付费用（如有）。
        	2.8	 甲方同意，甲方成功借款后，乙方可依据出借人的委托协调甲方按照约定期限及金额进行还款，甲方有义务无条件及时配合乙方工作。
        	2.9	 对于甲方应付乙方之服务费，甲方同意并授权乙方及其合作方指示第三方支付机构从甲方在放心花平台绑定的任一银行卡中进行划扣，直至服务费全额划扣支付成功。甲方应确保服务费支付账户有可供足额划扣的资金，因未按时支付服务费所产生的违约金由甲方承担。
        	2.10 甲方授权乙方通过其运营的放心花平台系统以甲方名义以电子签章方式自动签署相关《借款服务协议》、《借款合同》、《委托扣款授权书》等经甲方在线确认的相关协议文本；乙方将按照甲方上述授权予以执行，甲方对此等自动签署相关协议文本的安排已充分知悉，并认可该等自动签署的协议文本内容为甲方真实意思表示，甲方对该等法律文件的效力均予以认可且无任何异议，并无条件接受该等法律文件的约束。
        	2.11 借款期限内，甲方应下列事实变更之日起三（3）日内通过放心花平台提供更新后的信息给乙方（包含但不限于）：甲方还款银行账户、甲方本人、甲方家庭联系人以及紧急联系人的工作单位、居住地址、通讯地址、住所电话、手机号码、电子邮箱，若因甲方不及时提供上述变更信息而带来的所有损失，均由甲方承担。
