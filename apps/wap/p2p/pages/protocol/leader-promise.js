...
class LeaderPromise extends React.Component {
    ...
    <br /><br />1）借款及服务协议所指“借款利率”均为预期年化利率，不代表出借人最终实际收益；
    <br /><br />2）在出借实际收益未达到预期收益的情况下，出借人仅能根据实际收益取得收益；
    <br /><br />3）平台未以任何形式对出借人的出借资金及收益提供保证或担保；
    <br /><br />4）出借人的出借资金及收益可能存在不能按期收回的风险。
    ...
    <br /><br />8、如本出借人违反上述约定的任一承诺和保证，本出借人同意平台有权单方解除双方签署的《出借人咨询服务协议》，并承担因此造成的所有损失。
    <br /><br />本出借人确认：如违反上述承诺及保证，本出借人自愿承担因此引发的全部责任及损失。
    <br /><br />注：本承诺书中“本出借人”是指在本平台注册，并以其自有合法资金通过本平台提供的信息服务获取收益的用户，包括平台各类借款项目出借人、债权受让人等。
</div>
        </div>
    }
}
