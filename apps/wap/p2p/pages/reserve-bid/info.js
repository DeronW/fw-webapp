        ...
        let ruler_section = () => {
            return <div styleName="rulerBox">
                ...
                <div styleName="rulerContent">
                    ...
                    <br/>3.
                    加息部分收益在预约项目到期后以工豆形式发放到出借人账户中，如果因出借人将部分/全部回款资金中途退出或者提现，导致部分/全部回款资金复投失败的，复投失败的资金不享受加息部分收益，剩余复投成功的资金按照期限享受加息收益。加息收益=最后一期的实际出借金额*出借期限/360*计息比例。如果是非因出借人原因导致复投失败的，则平台会按照出借人实际出借期限享受加息收益；
