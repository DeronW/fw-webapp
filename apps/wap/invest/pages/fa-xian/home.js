    ...
    render() {
        ...
        return <div styleName="home">
            ...
            <div styleName="channel">
                ...
                <a onClick={() => this.gotoHandler('https://m.easyloan888.com/static/loan/3rd/index.html#/jrgc-login')}><i styleName="icon icon-waiting"></i>敬请期待</a>
            </div>
            ...
            <div styleName="contact-us">
                ...
                <a styleName="about-us">
                    ...
                    <span styleName="about-us-grey">关于我们</span>
                </a>
            </div>
        </div>
    }
