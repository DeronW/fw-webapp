        ...
        let gen_input_field = (fieldName) => {
            ...
            return (
                <div styleName="input-field">
                    ...
                    <div styleName="float-right-els" style={{ color: valueInStore ? "#666" : "#999" }}>
                        { field.options ?
                            <Select placeholder={field.placeholder} value={valueInStore} options={field.options} handleChange={this.props.currentOrder.setData('car', field)} /> :
                            <input styleName="input-area" placeholder={field.placeholder} value={valueInStore} onChange={this.props.currentOrder.setData('car', field)} />
                        }
                    </div>
                </div>
            )
            ...
            return (
                <div styleName="input-field">
                    ...
                    <div styleName="float-right-els">
                        <Select style={{ color: valueInStore[0] ? "#666" : "#999" }} placeholder={field.subField[0].placeholder} value={valueInStore[0]} options={field.subField[0].options} handleChange={this.props.currentOrder.setData('car', field.subField[0].fieldName)} /> :
                        <input style={{ color: valueInStore[1] ? "#666" : "#999" }} styleName="input-area" placeholder={field.subField[1].placeholder} value={valueInStore[1]} onChange={this.props.currentOrder.setData('car', field.subField[1].fieldName)} />
                    </div>
                </div>
            )
        }
