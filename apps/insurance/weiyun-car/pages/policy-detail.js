...
class PolicyDetail extends React.Component {
    ...
    changeHandler = field => e => this.props.policy_detail.setFormData(field, e.target.value)
            ...
            return (
                <div key={fieldName} styleName="input-field">
                    ...
                    <div styleName="right-els">
                        { field.hasBujimian &&
                            <div styleName="bujimian-input" style={{ background: `${bjmIconUrl} #fff no-repeat left`}}
