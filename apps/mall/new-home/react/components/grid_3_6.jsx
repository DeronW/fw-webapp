const Grid_3_6 = React.createClass({
    ...
    render:function(){
        let theme2_top_product_item = (product,index) => {
            return (
                <a className="theme2-top-product-item" key={index} onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + product.bizNo)}>
        ...
        let theme2_btm_product_item = (product,index) => {
            return (
                <a className="theme2-btm-product-item" key={index} onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + product.bizNo)}>
                    <div className="theme2-btm-product-wrap">
                        ...
                        <div className="theme2-btm-product-info">
                            ...
                            <span className="theme2-btm-product-price">{product.rmbPrice==0.00? null:"¥"+product.rmbPrice+"+"}{product.score}工分</span>
                        </div>
                    </div>
                </a>
            )
