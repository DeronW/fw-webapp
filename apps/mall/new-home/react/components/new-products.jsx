                ...
                <div className="new-product-wrap">
                    <div className="new-left-product">
                        <a className="new-bg-1"
                           onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.ps[0].bizNo)}>
                    ...
                    <div className="new-right-product">
                        <div className="new-right-top-product">
                            <a className="new-bg-2"
                               onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.ps[1].bizNo)}>
                            ...
                            <a className="new-bg-3"
                               onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.ps[2].bizNo)}>
                                <div className="new-right-top-wrap">
                        ...
                        <div className="new-right-btm-product">
                            <a className="new-bg-4"
                               onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.ps[3].bizNo)}>
                            ...
                            <a className="new-bg-5"
                               onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.ps[4].bizNo)}>
                            ...
                            <a className="new-bg-6"
                               onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.ps[5].bizNo)}>
