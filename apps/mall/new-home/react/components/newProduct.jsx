            ...
            <div className="new-product-list">
                ...
                <div className="new-product-wrap">
                    <div className="new-left-product">
                        <a className="new-bg-1" onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.productFirstBizNo)}>
                    ...
                    <div className="new-right-product">
                        <div className="new-right-top-product">
                            <a className="new-bg-2" onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.productSecondBizNo)}>
                            ...
                            <a className="new-bg-3" onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.productThirdBizNo)}>
                                <div className="new-right-top-wrap">
                        ...
                        <div className="new-right-btm-product">
                            <a className="new-bg-4" onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.productForthBizNo)}>
                                <img className="new-img2" src={this.state.productForthImage}/>
                                <span className="new-img2-title">{this.state.productForthTitle}</span>
                                {/*<span className="new-img2-price">1280元起</span>*/}
                            </a>
                            <a className="new-bg-5" onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.productFifthBizNo)}>
                                <img className="new-img2" src={this.state.productFifthImage}/>
                                <span className="new-img2-title">{this.state.productFifthTitle}</span>
                                {/*<span className="new-img2-price">1280元起</span>*/}
                            </a>
                            <a className="new-bg-6" onClick={ () => gotoHandler('/static/mall/new-product-detail/index.html?bizNo=' + this.state.productSixthBizNo)}>
