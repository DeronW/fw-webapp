    ...
    render: function() {
        ...
        return ( <
            ...
            div className = "user-name" > { data.username } {
                ...
                src = { `images/usercenter_vip${data.vip_level - 1}_icon.png` }
                /></span >
            } < /div> <
            ...
            href = "/static/mall/order-list/index.html#unPay" >
            <
            ...
            a > <
            a className = "product-status-item"
            href = "/static/mall/order-list/index.html#prepare" >
            <
            ...
            a > <
            a className = "product-status-item"
            href = "/static/mall/order-list/index.html#shipping" >
            <
            ...
            a > <
            a className = "product-status-item"
            href = "/static/mall/order-list/index.html#complete" >
            <
            ...
            href = "/static/mall/order-list/index.html#all" >
            <
            ...
            href = "/static/mall/user-deliver-address/index.html?preview=true" >
            <
            span className = "item-name item-icon6" > 收货地址 < /span> <
            span className = "jump-arrow" > < /span> < /
            a > <
            a className = "personal-item"
            href = "/static/mall/user-voucher/index.html" >
            <
            span className = "item-name item-icon7" > 兑换券 < /span> <
            span className = "jump-arrow" > < /span> < /
            a > <
            a className = "personal-item"
            href = "/static/mall/pay-bank-card/index.html?id=user" >
            <
            ...
            a className = "list-box hide"
            href = "https://dougemall.qiyukf.com/client?k=b0ecf23066d7645f98686b64260485da&wp=1" >
            <
            ...
            a > <
            a className = "list-box"
            href = "/static/mall/user-help/index.html" >
            <
    ...
    render: function() {
        let hotProduct = (product, index) => {
            ...
            return ( <
                ...
                span className = "product-price" > { price == 0 ? null : `¥${price}` } { price == 0 || score == 0 ? "" : "+" } { score == 0 ? null : `${score}工分` } <
                /span> < /
                a >
            )
        }
...
$FW.DOMReady(function() {
            $FW.Ajax({
                ...
                enable_loading: 'mini'
            }).then(data => ReactDOM.render( < User data = { data }
                />, CONTENT_NODE));
