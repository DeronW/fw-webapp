const ACTIVITY_ID = 'dcd89c6a7ebf4173b78cf245315656c8';
...
$FW.DOMReady(function () {
    NativeBridge.setTitle('国庆七天乐 转盘天天乐');
    if ($FW.Utils.shouldShowHeader()) {
        ReactDOM.render(<Header title={"国庆七天乐 转盘天天乐"} back_handler={backward}/>, document.getElementById('header'));
    }
