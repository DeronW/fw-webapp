            ...
            render: function() {
                ...
                let allBlock = function(s) {
                    return ( <
                        ...
                        return ( <
                            div className = "order-area" > { this.props.index == 0 && (this.state.all.length != 0 ? allBlock("all") : blockText) } { this.props.index == 1 && (this.state.unPay.length != 0 ? allBlock("unPay") : blockText) } { this.props.index == 2 && (this.state.prepare.length != 0 ? allBlock("prepare") : blockText) } { this.props.index == 3 && (this.state.shipping.length != 0 ? allBlock("shipping") : blockText) } { this.props.index == 4 && (this.state.complete.length != 0 ? allBlock("complete") : blockText) } <
                            /div>
                        );
                    }
                });
                        ...
                        render: function() {
                                ...
                                $FW.DOMReady(function() {
                                            ...
                                            function back_handler() {
                                                if(document.referrer=='https://m.dougemall.com/static/mall/home/index.html'){
