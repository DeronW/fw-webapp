    ...
    render: function () {
        ...
        return (
            <div className={bgColor}>
                <div className="bank-tit"><img src={bankCards.cardImg}/><span
                    className="bank-name">{bankCards.bankCardName}</span><span
                    className="bank-type">{bankCards.bankCardType}</span></div>
