                ...
                <div className="pop-inf">
                    ...
                    <div className="pop-inf-cnt">
                        <div className="pop-inf-li">
                            ...
                            <div className="pop-inf-detail">2016年10月26日开始</div>
                        </div>
                        <div className="pop-inf-li">
                            <div className="pop-inf-h">二.活动奖品:</div>
                            <div className="pop-inf-detail">豆哥双肩包（星星款）、迪士尼电饼铛、10元返现券、5元返现券、2工分、0.6%返息券、20工分、5工分</div>
                        </div>
                        <div className="pop-inf-li">
...
4、所获得5元、10元返现券、0.6%返息券均为全场通用券，不限标的、期限（投资债权转让项目除外），返现券、返息券有效期7天。<br/>
5、本活动长期有效，实物奖品不定期更换，不再另行通知，以实时抽到奖品为准。<br/>
6、抽奖次数：普通用户，5次/每天/每人;VIP1用户，10次/每天/每人;VIP2用户，15次/每天/每人;VIP3用户，20次/每天/每人;VIP4用户，30次/每天/每人。<br/>
7、本活动规则解释权归金融工场所有。</div>
                        </div>                                             
                    </div>
