    ...
    render: function () {
        ...
        return (
            <div className="theme-3">
                <a href='/static/mall/product-list/index.html?searchSourceType=0&category=automobile&title=汽车用品' className="activity-theme"><img src="/static/mall/product-list/images/_automobile.jpg" /></a>
