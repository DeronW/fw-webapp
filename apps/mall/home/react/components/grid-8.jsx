    ...
    render() {
        ...
        return (
            <div className="theme-3">
                <a href= '/static/mall/product-list/index.html?searchSourceType=0&category=qualityLife&title=品质生活' className="activity-theme"><img
                    src="/static/mall/product-list/images/_qualityLife.jpg"/></a>
