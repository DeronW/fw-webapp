...
const Mall = React.createClass({
    ...
    render: function() {
        ...
        div className = "charge-flow" > < img src = "images/charge-flow.png" / > < /div> < /
            ...
            return ( <
                div className = "head-wrap" > { banner } <
                ...
                href = "/static/mall/user/index.html" >
                <
                ...
                <
                /div> <
                HotProducts bizNo = { 'TJ0000022' }
                count = { 10 }
                /> <
                NewProducts bizNo = { 'TJ0000060' }
                count = { 10 }
                /> <
                Grid_1 bizNo = { 'TJ0000042' }
                count = { 10 }
                /> <
                Grid_2 bizNo = { 'TJ0000044' }
                count = { 10 }
                /> <
                Grid_3 bizNo = { 'TJ0000046' }
                count = { 10 }
                /> <
                Grid_7 bizNo = { 'TJ0000054' }
                count = { 10 }
                /> <
                Grid_6 bizNo = { 'TJ0000052' }
                count = { 10 }
                /> <
                Grid_5 bizNo = { 'TJ0000050' }
                count = { 10 }
                /> <
                Grid_4 bizNo = { 'TJ0000048' }
                count = { 10 }
                /> <
                Grid_8 bizNo = { 'TJ0000056' }
                count = { 10 }
                />
...
$FW.DOMReady(function() {
            ...
            $FW.Ajax(`${API_PATH}/mall/api/index/v1/banners.json`)
                .then(data => ReactDOM.render( < Mall banners = { data.banners }
                    />, CONTENT_NODE));
                });