...
const Coupon = React.createClass({
    render: function() {
        ...
        return ( <
            ...
            id = "coupon-list" > { ls.map((l, index) => coupon(l, index)) } <
            /div>
        )
    }
});
...
const OrderStatusList = React.createClass({
    render: function() {
        ...
        return ( <
            ...
            span className = "data-text stake-text" > { status_name } <
            /span> < /
            div > { shipping } <
            /div>
        );
                        ...
                        return ( <
                            ...
                            div className = "tag-block" > {
                                d.tags.length != 0 ? products[0].tags.map((s, index) =>
                                    <
                                    span key = { index }
                                    className = "text" > { s } < /span>) : null } < /
                                    div > <
                                    div className = "commodity-number" >
                                    <
                                    span className = "money-text" > { pay_price } { d.price > 0 && d.score ? ' + ' : null } { score_cost } <
                                    /span> <
                                    ...
                                    <
                                    span className = "commodity-text" > 共 { order.count }
                                    件商品 < /span> <
                                ...
                                return ( <
                                    div className = "order-all" > { this.props.products.map((d, index) => orderBlock(d, index)) } <
                                    /div>
                                );
                            }
                        });
                    ...
                    const OrderPayInfo = React.createClass({
                        render: function() {
                            ...
                            if (payment.score) {
                                ...
                                span className = "data-text" > { payment.score }
                                工分 < /span> < /
                                div >
                            }
                            if (payment.bean) {
                            ...
                            return ( <
                                ...
                                div > <
                                div className = "l-r-text" > { ticket } { money } { bean } { score } <
                                /div> < /
                                div >
                            );
                        }
                    ...
                    const OrderNumberList = React.createClass({
                        render: function() {
                            ...
                            return ( <
                                ...
                                <
                                div className = "sequence" > { pay_at } { deliver_at } { receive_at } <
                                /div> < /
                                div >
                            );
                        }
                    ...
                    $FW.DOMReady(function() {
                                ...
                                $FW.Ajax({
                                    ...
                                    success: function(data) {
                                        ReactDOM.render( < OrderDetail {...data }
                                            />, CONTENT_NODE);
                                        }
                                    }); ReactDOM.render( < Header title = { "订单详情" }
                                    />, HEADER_NODE);
                                });