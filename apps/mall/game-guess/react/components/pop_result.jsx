        ...
        if(data.level==0){
            win=<div className={"pop-win-box pop-win-box"+data.level}>
                <div className="pop-win-cnt">
                    ...
                    <div className="pop-win-btn">
                        <div className="win-tip">第{(data.level+1)%3+1}局胜利可得{data.next_get_prize}哦<div className="win-tip-triangle">&nbsp;</div></div>
                        <div className="win-on" onClick={()=>{data.nextHandler((data.level+1)%3)}}><span>{data.next_cost_score}</span>&nbsp;继续挑战</div>
            ...
            win=<div className={"pop-win-box pop-win-box"+data.level}>
                <div className="pop-win-cnt">
                    ...
                    <div className="pop-win-get">本局获得:&nbsp;<span>{data.get_prize}</span></div>
                    <div className="pop-win-btn">
                        <div className="win-tip">没玩够？想赚更多<div className="win-tip-triangle">&nbsp;</div></div>
                        <div className="win-on" onClick={()=>{data.nextHandler((data.level+1)%3)}}><span></span>&nbsp;再来一轮</div>
