                ...
                <div className="inf-box">
                    ...
                    <div className="inf-cnt-box">
                        <div className="inf-cnt">
                            ...
                            <div className="inf-cnt-li">1、10工分即可参与大转盘抽奖一次，大转盘100%有奖；<br/>2、抽奖获得任意奖品，均实时发放(实物奖品以兑换券形式实时发放到工场账户，中奖者到豆哥商城自行兑换)；<br/>3、所获得5元返现券为全场通用券，不限标的（债权转让除外）；<br/>4、本活动规则解释权归金融工场所有。</div>
                        </div>
                    </div>
                </div>
