...
(function () {
    ...
    var THEME_DICT = {
        default: {
            tabbar: true,
            header: true,
            weixin_download_page: '/static/loan/user-weixin-new-download/index.html?name=OFFICIAL'
        },
        jrgc_app: {
            tabbar: false,
            weixin_download_page: '/static/loan/user-weixin-new-download/index.html'
        },
        fxh_app: {
            weixin_download_page: '/static/loan/user-weixin-new-download/index.html'
        },
