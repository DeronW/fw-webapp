(function () {
    ...
    $FW.Store = {
        ...
        */
        ...
        // set bulletin content binding with a certain uid
        setBulletin: function (uid, cnt) {
            this.set('bulletinUid', uid);
            this.set('bulletinCnt', cnt);
        },

        // if a bulletin is read for provided uid
        isBulletinRead: function (uid, cnt) {
            return (this.get('bulletinUid') === uid) && (this.get('bulletinCnt') === cnt)
        }
    }
})();
