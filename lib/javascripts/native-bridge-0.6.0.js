(function () {
    ...
    */
    Bridge.prototype = {
        ...
        setTitle: function (title) {
            if (this.isReady) {
                ...
                callHandler.call(this, createPackage('set_title', title))
            } else {
                this.ready(function () {
        ...
        share: function (link, title, img, desc) {
            callHandler.call(this, createPackage('share', {
                title: title,
                image: img,
                link: link,
                desc: desc
        ...
        trigger: function (action_name) {
            this.isReady ?
                this.bridge.callHandler('nativeCallback', { action: action_name }) :
    ...
    function callHandler(package) {
        this.bridge.callHandler('nativeCallback', package)
    }
...
// window.onNativeMessageReceive = function(){
//     console && console.error && console.error('还没有定义接受来自native的方法: onNativeMessageReceive')
// }
