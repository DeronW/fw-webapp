        ...
        , Event: {
            ...
            touchBottom: function (cb) {
                ...
                window.addEventListener("scroll", function () {
                    ...
                    console.log(window.screen.height, document.body.scrollTop, document.body.scrollHeight);
                    //判断滚动条滚到了网页最底部
                    if (window.screen.height + document.body.scrollTop + 50 > document.body.scrollHeigh) {
                        cb(function () {
