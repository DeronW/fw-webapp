...
(function (func) {
    ...
    var fn = FinancialWorkspace.prototype = {
        ...
        , Event: {
            ...
            touchBottom: function (cb) {
                ...
                window.addEventListener("scroll", function () {
                    console.log(window.innerHeight, document.body.scrollTop, document.body.scrollHeight);
                    //判断滚动条滚到了网页最底部
        ...
        , Browser: {
            inApp: function () {
                return navigator.userAgent.indexOf('FinancialWorkshop');
            },
            inMobile: function () {
    ...
    function handleErrorCode(code, msg) {
        if (code == 10000) {
            ...
            if (FinancialWorkspace.Browser.inApp() && NativeBridge) {
                ...
                location.href = 'http://m.9888.cn/orderuser/toLogin.shtml?redirect_url=m.mall.9888.cn'
            }
        } else if (code == 60101) {
            alert('短信验证码不存在')
        } else if (code == 60102) {
