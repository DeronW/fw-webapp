    ...
    render: function () {
		...
		return (
                <div className="_style_footer_fixed" style={_style_footer_fixed}>
					...
					<a className={this.props.index==3 ? "_style_footer_item3 active" : "_style_footer_item3"}  style={_style_footer_item3} onClick={ () => gotoHandler("/static/mall/shopping-cart/index.html", true) }></a>
