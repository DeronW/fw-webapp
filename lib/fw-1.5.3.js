(function (func) {
    ...
    var FW = FinancialWorkspace = function (selector) { };
    ...
    var fn = FW.prototype = {
        DOMReady: function (callback) {
            document.readyState == 'complete' ? callback() : FW._global.readyList.push(callback);
        },
        ...
        Ajax: function (options) {
            ...
            if (cfg.enable_loading) FinancialWorkspace.Component.showAjaxLoading(cfg.enable_loading_theme);
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState == 4) {
                        ...
                        if (xhr.status == 200 || xhr.status == 201) {
                            ...
                            $FW.Component.Alert('ERROR, HTTP Status Code: ' + xhr.status);
                        }
                    }
                };
            });
        ...
        Utils: {
            ...
            _login: function (param) {
                if (FW.Browser.inApp() && NativeBridge) {
                    ...
                    // is_mall=2 WAP
                    location.href = location.protocol + '//m.9888.cn/mpwap/orderuser/toLogin.shtml?' + param + '&redirect_url=' + FinancialWorkspace.getLoginRedirect();
                }
            },
            loginMall: function () {
        ...
        Component: {
            ...
            showAjaxLoading: function (theme) {
                ...
                // setTimeout(FW.Component.hideAjaxLoading, 9900);
            },
