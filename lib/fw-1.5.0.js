    ...
    var fn = FW.prototype = {
        ...
        Event: {
            ...
            cancelSlideDownRefresh: function(){
                window.body.removeEventListener('touchmove', FW._global.eventMap['slide_down_refresh'][0]);
                window.body.removeEventListener('touchend', FW._global.eventMap['slide_down_refresh'][1]);
