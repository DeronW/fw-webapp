(function (func) {
    ...
    var fn = FW.prototype = {
        ...
        Ajax: function (options) {
            ...
            // 添加ajax加载样式的默认主题
            if (cfg.enable_loading === true && !cfg.enable_loading_theme)
                cfg.enable_loading_theme = 'default';
