...
(function (func) {
    ...
    var fn = FinancialWorkspace.prototype = {
        ...
        , Event: {
            ...
            touchBottom: function (cb) {
                ...
                window.addEventListener("scroll", function () {
                    console.log(window.innerHeight, document.documentElement.scrollTop, document.body.scrollTop, document.body.scrollHeight, ' delta:',
                        document.body.scrollHeight - (window.innerHeight + document.body.scrollTop + document.documentElement.scrollTop));
                    //判断滚动条滚到了网页最底部
        ...
        , Browser: {
            ...
            version: function(){
                return navigator.userAgent.match(/FinancialWorkshop\/(\d+.\d+.\d+)/);
            },
            inMobile: function () {
